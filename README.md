# unit-tests-beerstock

This project was developed to training about creating unit tests on an API REST application using Java with Spring Boot, JUnit, Mockito and Hamcrest on Everis bootcamp course "Desenvolvimento de testes unitários para validar uma API REST de gerenciamento estoques de cerveja" from "Digital Innovation One" platform.
